...
export class LogSinkService implements OnModuleDestroy {
  ...
  private buildLogRecord(log: CallLog, sink: LogSinkConfig): Record<string, unknown> {
    const raw: Record<string, unknown> = {
      ...
      client_source: log.client_source || null,
      tier: log.tier,
      ...
      reasoning_budget_tokens: log.reasoning_budget_tokens ?? null,
      reasoning_source: log.reasoning_source || null,
      reasoning_reason: log.reasoning_reason || null,
      media_type: log.media_type || null,
      media_operation: log.media_operation || null,
      media_multipart: log.media_multipart ?? null,
      media_file_count: log.media_file_count ?? null,
      media_byte_size: log.media_byte_size ?? null,
      media_requested_format: log.media_requested_format || null,
      media_response_format: log.media_response_format || null,
      media_provider_response_type: log.media_provider_response_type || null,
