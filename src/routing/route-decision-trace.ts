...
export interface RouteDecisionCostOptimizerCandidateEvidence {
  node: string;
  model: string;
  estimated_cost_usd: number | null;
...
export interface RouteDecisionCostOptimizerEvidence {
  ...
  candidates: RouteDecisionCostOptimizerCandidateEvidence[];
}
...
export interface RouteDecisionQualityGateEvent {
  rule_id: string;
...
export interface RouteDecisionQualityGateEvidence {
  ...
  events: RouteDecisionQualityGateEvent[];
  reason: string;
}
