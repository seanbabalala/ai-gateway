...
export const BUILTIN_PROVIDER_CATALOG: CatalogProvider[] = [
  ...
  provider({
    ...
    model_prefixes: ['deepseek-ai/', 'meta-llama/', 'Qwen/', 'mistralai/'],
    capabilities: ['openai_compatible', 'streaming', 'tools', 'structured_output', 'open_weights'],
    pricing: referencePricing(
      'https://deepinfra.com/pricing',
      'DeepInfra publishes per-model prices for hosted open-weight inference; review the selected model page before production cost routing.',
    ),
    models: [
      {
        ...
        modalities: ['text'],
        endpoints: { chat_completions: '/chat/completions' },
        capabilities: ['streaming', 'tools', 'structured_output', 'open_weights'],
        pricing: referencePricing(
          'https://docs.deepinfra.com/chat/overview',
          'DeepInfra chat model prices are model-specific and should be reviewed against the live catalog.',
        ),
      },
      {
        ...
        pricing: referencePricing(
          ...
          'DeepInfra open-weight model availability and token prices can change by model revision.',
        ),
      },
    ],
  }),
  provider({
    ...
    family: 'foundation_model',
    provider_type: 'direct',
    homepage_url: 'https://nebius.com/studio/inference',
    docs_url: 'https://docs.studio.nebius.com/api-reference/inference/create-chat-completion',
    pricing_url: 'https://preview.nebius.ai/prices-ai-studio',
    logo_id: 'nebius',
    ...
    model_prefixes: ['meta-llama/', 'Qwen/', 'google/', 'black-forest-labs/'],
    capabilities: ['openai_compatible', 'streaming', 'tools', 'vision', 'open_weights'],
    pricing: referencePricing(
      'https://preview.nebius.ai/prices-ai-studio',
      'Nebius AI Studio prices vary by model flavor and batch mode; review the pricing table before cost routing.',
    ),
    models: [
      {
        ...
        modalities: ['text'],
        endpoints: { chat_completions: '/chat/completions' },
        capabilities: ['streaming', 'tools', 'open_weights'],
        pricing: referencePricing(
          'https://docs.studio.nebius.com/api-reference/inference/create-chat-completion',
          'Nebius chat completion docs provide request shape; verify model-specific rates in AI Studio pricing.',
        ),
      },
      {
        id: 'BAAI/bge-en-icl',
        ...
        capabilities: ['embeddings', 'open_weights'],
        pricing: referencePricing(
          'https://preview.nebius.ai/prices-ai-studio',
          'Nebius embedding prices are model-specific and require operator review.',
        ),
      },
    ],
  }),
  provider({
    ...
    model_prefixes: ['meta-llama/', 'deepseek/', 'qwen/', 'mistral/'],
    capabilities: ['openai_compatible', 'streaming', 'batch', 'embeddings', 'rerank', 'open_weights'],
    pricing: referencePricing(
      'https://novita.ai/pricing',
      'Novita AI publishes model/API pricing, but production routing should review the selected model and account terms.',
    ),
    models: [
      {
        id: 'meta-llama/llama-3.3-70b-instruct',
        modalities: ['text', 'batch'],
        endpoints: { chat_completions: '/chat/completions', batch: '/batches' },
        capabilities: ['streaming', 'batch', 'open_weights'],
        limits: { max_context_tokens: 131072 },
        pricing: referencePricing(
          'https://novitaai.mintlify.dev/docs/api-reference/model-apis-llm-list-models',
          'Novita model-list metadata includes token prices in API units; review before converting to production cost routing.',
        ),
      },
      {
        ...
        capabilities: ['streaming', 'open_weights'],
        pricing: referencePricing(
          'https://novita.ai/llama3',
          'Novita Llama model marketing pages are a reference only; use reviewed overrides for production.',
        ),
      },
    ],
  }),
  provider({
    id: 'friendli',
    name: 'FriendliAI',
    aliases: ['friendli', 'friendli ai', 'friendliai', 'friendli engine'],
    family: 'foundation_model',
    provider_type: 'direct',
    homepage_url: 'https://friendli.ai',
    docs_url: 'https://friendli.ai/docs/guides/serverless_endpoints/openai_compatibility',
    pricing_url: 'https://friendli.ai/pricing',
    logo_id: 'friendli',
    ...
    model_prefixes: ['meta-llama/', 'deepseek-ai/', 'Qwen/'],
    capabilities: ['openai_compatible', 'streaming', 'tools', 'structured_output', 'open_weights'],
    pricing: referencePricing(
      'https://friendli.ai/pricing',
      'Friendli pricing depends on serverless, dedicated endpoint, or container mode; review current rates before cost routing.',
    ),
    models: [
      {
        id: 'meta-llama/Llama-3.1-8B-Instruct',
        ...
        pricing: referencePricing(
          ...
          'Friendli serverless model support and pricing should be reviewed against the current serverless model table.',
        ),
      },
      {
        id: 'meta-llama-3.3-70b-instruct',
        ...
        pricing: referencePricing(
          ...
          'Friendli OpenAI-compatible examples are transport evidence; verify per-model pricing separately.',
        ),
      },
    ],
  }),
  provider({
    ...
    aliases: ['databricks', 'mosaic ai', 'databricks model serving', 'foundation model api'],
    family: 'cloud_platform',
    provider_type: 'cloud',
    homepage_url: 'https://www.databricks.com/product/machine-learning/foundation-model-apis',
    docs_url: 'https://docs.databricks.com/en/machine-learning/foundation-models/api-reference.html',
    pricing_url: 'https://www.databricks.com/product/pricing/model-serving',
    logo_id: 'databricks',
    base_url: 'https://{workspace}.cloud.databricks.com/serving-endpoints',
    auth_type: 'bearer',
    endpoints: {
      chat_completions: '/{endpoint}/invocations',
      embeddings: '/{endpoint}/invocations',
    },
    model_prefixes: ['databricks-', 'mpt-', 'llama', 'mixtral', 'bge-'],
    capabilities: ['cloud_platform', 'managed_models', 'openai_compatible', 'deployment_pricing', 'enterprise'],
    pricing: referencePricing(
      'https://docs.databricks.com/en/machine-learning/foundation-model-apis/index.html',
      'Databricks pricing depends on pay-per-token versus provisioned throughput, workspace, region, and serving endpoint configuration.',
    ),
    models: [
      {
        id: 'databricks-meta-llama-3-3-70b-instruct',
        modalities: ['text'],
        endpoints: { chat_completions: '/{endpoint}/invocations' },
        capabilities: ['enterprise', 'streaming', 'open_weights'],
        pricing: referencePricing(
          'https://docs.databricks.com/en/machine-learning/foundation-models/api-reference.html',
          'Databricks Foundation Model APIs use workspace serving endpoints; model and pricing availability are account/region specific.',
        ),
      },
      {
        id: 'databricks-bge-large-en',
        modalities: ['text', 'embedding'],
        endpoints: { embeddings: '/{endpoint}/invocations' },
        capabilities: ['enterprise', 'embeddings'],
        pricing: referencePricing(
          'https://docs.databricks.com/en/machine-learning/foundation-model-apis/index.html',
          'Databricks embedding serving costs depend on the selected Foundation Model API mode or provisioned endpoint.',
        ),
      },
    ],
  }),
  provider({
    id: 'github-models',
    name: 'GitHub Models',
    aliases: ['github models', 'github-models', 'models.github.ai'],
    family: 'aggregator',
    provider_type: 'aggregator',
    homepage_url: 'https://github.com/marketplace/models',
    docs_url: 'https://docs.github.com/en/rest/models/inference',
    pricing_url: 'https://docs.github.com/en/github-models',
    logo_id: 'github-models',
    base_url: 'https://models.github.ai',
    auth_type: 'bearer',
    endpoints: {
      chat_completions: '/orgs/{org}/inference/chat/completions',
    },
    model_prefixes: ['openai/', 'microsoft/', 'meta/', 'deepseek/'],
    capabilities: ['openai_compatible', 'model_marketplace', 'multi_provider', 'streaming', 'tools'],
    pricing: referencePricing(
      'https://docs.github.com/en/github-models',
      'GitHub Models availability, quotas, and billing depend on GitHub plan, model, and organization attribution.',
    ),
    models: [
      {
        id: 'openai/gpt-4.1',
        modalities: ['text'],
        endpoints: { chat_completions: '/orgs/{org}/inference/chat/completions' },
        capabilities: ['streaming', 'tools', 'structured_output'],
        pricing: referencePricing(
          'https://docs.github.com/en/rest/models/inference',
          'GitHub Models REST inference supports chat completions with organization attribution; review model availability and billing in GitHub.',
        ),
      },
      {
        ...
        pricing: referencePricing(
          'https://docs.github.com/en/rest/models/inference',
          'GitHub Models catalog entries can change; verify model access and account limits before production routing.',
        ),
      },
    ],
  }),
