...
{{- default (printf "%s-env" (include "siftgate.fullname" .)) .Values.secrets.existingSecret -}}
{{- end -}}
...
{{- default (printf "%s-config" (include "siftgate.fullname" .)) .Values.config.existingConfigMap -}}
{{- end -}}
