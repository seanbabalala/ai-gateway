...
- Include `config_versions`, `config_audit_events`, and
  `management_audit_events` in PostgreSQL backups and restore tests if you rely
  on Dashboard rollback or management audit evidence during incident response.
