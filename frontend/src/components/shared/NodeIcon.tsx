...
const PROVIDER_REGISTRY: ProviderIdentity[] = [
  ...
  },
  {
    id: 'deepinfra',
    label: 'DeepInfra',
    keywords: ['deepinfra', 'deep infra'],
    hostnames: ['api.deepinfra.com', 'deepinfra.com'],
    modelPrefixes: ['deepseek-ai/', 'meta-llama/', 'qwen/', 'mistralai/'],
    badge: 'DI',
  ...
  },
  {
    ...
    keywords: ['nebius', 'nebius ai studio'],
    hostnames: ['api.studio.nebius.com', 'nebius.com'],
    modelPrefixes: ['meta-llama/', 'qwen/', 'black-forest-labs/'],
    badge: 'N',
    badgeClassName: 'bg-blue-800 text-white dark:bg-blue-300 dark:text-slate-950',
  },
  {
    id: 'novita',
    label: 'Novita AI',
    ...
    modelPrefixes: ['meta-llama/', 'deepseek/', 'qwen/', 'mistral/'],
    badge: 'NV',
    badgeClassName: 'bg-rose-700 text-white dark:bg-rose-300 dark:text-slate-950',
  },
  {
    id: 'friendli',
    label: 'FriendliAI',
    keywords: ['friendli', 'friendli ai', 'friendliai'],
    hostnames: ['api.friendli.ai', 'friendli.ai'],
    modelPrefixes: ['meta-llama/', 'deepseek-ai/', 'qwen/'],
    badge: 'FR',
    badgeClassName: 'bg-teal-800 text-white dark:bg-teal-300 dark:text-slate-950',
  },
  {
    id: 'databricks',
    label: 'Databricks Mosaic AI',
    keywords: ['databricks', 'mosaic ai', 'foundation model api'],
    hostnames: ['cloud.databricks.com', 'databricks.com'],
    modelPrefixes: ['databricks-', 'mpt-', 'llama', 'mixtral', 'bge-'],
    badge: 'DB',
    badgeClassName: 'bg-red-600 text-white dark:bg-red-300 dark:text-slate-950',
  },
  {
    id: 'github-models',
    label: 'GitHub Models',
    keywords: ['github-models', 'github models', 'github'],
    hostnames: ['models.github.ai', 'github.com'],
    modelPrefixes: ['openai/', 'microsoft/', 'meta/', 'deepseek/'],
